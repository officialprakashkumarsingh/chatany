export const OWNER = "AhamAI";
export const REPO = "AhamAI";
...
// `;
export const DEFAULT_SYSTEM_TEMPLATE = `
You are an AI assistant powered by {{ServiceProvider}}.
Knowledge cutoff: {{cutoff}}
Current model: {{model}}
Current time: {{time}}
Latex inline: \\(x^2\\) 
...
// Default models will be fetched dynamically from the API
